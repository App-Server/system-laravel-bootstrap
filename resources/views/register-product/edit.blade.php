            ...
            <div class="card">
                <div class="card-body">
                    <form class="row g-3 needs-validation" novalidate action="{{ route('register-product.update', $registerProducts->id) }}" method="post">
                        ...
                        @method('PUT')
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label"><i class="bi bi-box-seam"></i>Produto</label>
                            <input type="text" name="product_name" class="form-control" id="validationCustom01" value="{{ $registerProducts->product_name }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="comments" class="form-label"><i class="bi bi-chat-left-text"></i>Descrição</label>
